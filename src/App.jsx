...
const MushroomWholesale = React.lazy(() => import('./pages/MushroomWholesale'));
    ...
    <Suspense fallback={<LoadingSpinner />}>
      <Routes>
        ...
        <Route path="/Pantry" element={
          <LayoutWrapper currentPageName="Pantry">
            <Pantry />
          </LayoutWrapper>
        } />
        ...
        <Route path="/Professionals" element={
          <LayoutWrapper currentPageName="Professionals">
            <Professionals />
          </LayoutWrapper>
        } />
        <Route path="/SeedStarting" element={
          <LayoutWrapper currentPageName="SeedStarting">
            <SeedStarting />
          </LayoutWrapper>
        } />
        <Route path="/MushroomCultivation" element={
          <LayoutWrapper currentPageName="MushroomCultivation">
            <MushroomCultivation />
          </LayoutWrapper>
        } />
        ...
        <Route path="/MushroomWholesale" element={
          <LayoutWrapper currentPageName="MushroomWholesale">
            <MushroomWholesale />
          </LayoutWrapper>
        } />
