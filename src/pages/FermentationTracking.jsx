...
import FermentationDrafts from "../components/fermentation/FermentationDrafts";
  ...
  return (
    <div className="min-h-screen p-4 md:p-8 pb-32">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Saved Drafts (offline-accessible) */}
        <FermentationDrafts userEmail={currentUser?.email} onResume={handleResumeDraft} />
